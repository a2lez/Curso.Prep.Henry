...
function devolverUltimoElemento(array) {
  ...
  // Tu código:
  let UltimoV = array[array.length - 1];
  return UltimoV;
}
...
function promedioResultadosTest(resultadosTest) {
  ...
  return promedio = suma/denominador;
}
